...
description: Advanced operational skill for customer-discovery-script-builder.
read_when:
  - When working in idea-validation workflows
  - When user asks for customer discovery script builder
...
# Customer Discovery Script Builder
    ...
    Advanced operational skill for customer-discovery-script-builder.

    ## Activation trigger

    Use this skill when the user requests **customer discovery script builder** and needs a high-confidence, decision-ready outcome in **idea-validation**.
...
- If high-risk uncertainty remains, return a gated recommendation instead of false precision.
    ...
    ```shell
    $customer-discovery-script-builder "Run customer discovery script builder on my current project context"
