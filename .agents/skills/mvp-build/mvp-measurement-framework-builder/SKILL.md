...
description: Advanced operational skill for mvp-measurement-framework-builder.
read_when:
  - When working in mvp-build workflows
  - When user asks for mvp measurement framework builder
...
# Mvp Measurement Framework Builder
    ...
    Advanced operational skill for mvp-measurement-framework-builder.

    ## Activation trigger

    Use this skill when the user requests **mvp measurement framework builder** and needs a high-confidence, decision-ready outcome in **mvp-build**.
...
- If high-risk uncertainty remains, return a gated recommendation instead of false precision.
    ...
    ```shell
    $mvp-measurement-framework-builder "Run mvp measurement framework builder on my current project context"
